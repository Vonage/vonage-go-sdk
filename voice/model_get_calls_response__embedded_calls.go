...
package voice
// GetCallsResponseEmbeddedCalls struct for GetCallsResponseEmbeddedCalls
type GetCallsResponseEmbeddedCalls struct {
	Links GetCallsResponseEmbeddedLinks `json:"_links,omitempty"`
