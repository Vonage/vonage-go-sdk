...
// List of niStandardAdvancedStatus
const (
	_0 NiStandardAdvancedStatus = 0
	_1 NiStandardAdvancedStatus = 1
	_3 NiStandardAdvancedStatus = 3
	_4 NiStandardAdvancedStatus = 4
	_5 NiStandardAdvancedStatus = 5
	_9 NiStandardAdvancedStatus = 9
	_19 NiStandardAdvancedStatus = 19
	_43 NiStandardAdvancedStatus = 43
	_44 NiStandardAdvancedStatus = 44
	_45 NiStandardAdvancedStatus = 45
	_999 NiStandardAdvancedStatus = 999
)
